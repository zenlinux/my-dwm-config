...
/* tagging */
static const char *tags[] = { "1:web", "2:Term", "3:Emacs", "4:Gvim", "5:Files", "6:Zathura", "7:Gimp", "8:Inkscape", "9:Office" };
...
static Key keys[] = {
	...
	{ 0,                            XK_Print,  spawn,          SHCMD("exec scrot -q 90 '%Y-%m-%d-%H-%M-%S.png' -e 'mv $f ~/.scrots'") }, 
	{ ALTMODKEY,                    XK_m,      setlayout,      {.v = &layouts[2]} },
	{ ALTMODKEY,                    XK_p,      spawn,          {.v = rofiruncmd } },
	{ ALTMODKEY|ShiftMask,          XK_d,      incnmaster,     {.i = -1 } },
	{ ALTMODKEY|ShiftMask,          XK_i,      incnmaster,     {.i = +1 } },
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	/* mapping the letter key 'o' to easily toggle the terminator tag no. 2 */
	TAGKEYS(                        XK_o,                      1)
	/* mapping the letter key 'i' to easily toggle the emacs tag no. 3 */
	TAGKEYS(                        XK_i,                      2)
